...
# Plots 4 graphs:
# 1. The Global Active Power variable over time (over the 2 days)
# 2. The Voltage over time
# 3. The three sub metering variables over time
# 4. The Global reactive power over time
